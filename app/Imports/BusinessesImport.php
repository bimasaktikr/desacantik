...
class BusinessesImport implements ToCollection, WithHeadingRow, WithStartRow, WithValidation, WithMultipleSheets
{
    ...
    public function customValidationMessages()
    {
        return [
            ...
            'jenis_kelamin.in' => 'Jenis kelamin harus "-" atau Laki-Laki atau Perempuan',
            'apakah_pemilik_mau_mengikuti_pembinaan.in' => 'Pembinaan harus "-" atau Ya atau Tidak',
            'apakah_memiliki_online.in' => 'Status online harus "-" atau Ya atau Tidak',
